...
export const SecondGameSocialScienceScreen = () => {
    const {} = useAudio("second_game_social_science_instructions.mp3"); 
                ...
                <GameEngine
                    ...
                    entities = {{
                        ...
                        tail : {
                            ...
                            itemsIndex : 0,
                            imageItems : civilizationsData,
                            maxNumberItems : civilizationsData.length-1
                        }
                    }}
                    systems = {[
                        Gameloop
