...
export const SecondGameNaturalScienceScreen = () => {
    const {} = useAudio("second_game_natural_science_instructions.mp3"); 
                ...
                <GameEngine
                    ...
                    entities = {{
                        ...
                        tail : {
                            ...
                            itemsIndex : 0,
                            imageItems : animalsData,
                            maxNumberItems : animalsData.length-1
                        }
                    }}
                    systems = {[
                        Gameloop
